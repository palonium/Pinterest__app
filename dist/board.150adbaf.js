...
var BoardList = /*#__PURE__*/function () {
  ...
  _createClass(BoardList, [{
    ...
    key: "bildListBoard",
    value: function bildListBoard() {
      var boards = document.getElementById('boards');
      this.arrBoard.forEach(function (item) {
...
var board = new Board();
var addBoarb = document.getElementById('addBoard');
addBoarb.addEventListener('click', function () {
  var NameBoard = document.querySelector('#NameBoard');
  boardList.addBoard(new Board(NameBoard.value));
  document.querySelectorAll('option').forEach(function (itm) {
    return itm.remove();
  });
...
},{}]},{},["C:/Users/admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/board.js"], null)
//# sourceMappingURL=/board.150adbaf.js.map