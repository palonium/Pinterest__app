...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/pictures.js":[function(require,module,exports) {
'use strict';
...
var Picture = /*#__PURE__*/function () {
  function Picture(id, src, alt, tags, avatarSrc) {
...
for (var i = 0; i < photosData.length; i++) {
  ...
  var picture = new Picture("pic".concat(i + 1), photo.src, photo.alt, photo.tags, photo.avatarSrc);
  picture.addToPage();
}
...
searchInput.addEventListener("input", function () {
  ...
  for (var _i = 0; _i < photosData.length; _i++) {
    var _photo = photosData[_i];
    if (_photo.tags.toLowerCase().includes(searchTerm)) {
      var _picture = new Picture("pic".concat(_i + 1), _photo.src, _photo.alt, _photo.tags, _photo.avatarSrc);
      _picture.addToPage();
    }
  }
});
...
},{}]},{},["C:/Users/admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/pictures.js"], null)
//# sourceMappingURL=/pictures.cf023845.js.map