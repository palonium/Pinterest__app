...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/modal-windows.js":[function(require,module,exports) {
'use strict';

var pictureItems = document.querySelectorAll('.pictures-item');
var pictures = document.querySelectorAll('.pictures__pic-box');
var pick = document.querySelector('.pictures__pic-box');
var body = document.querySelector('body');
var lockPadding = document.querySelectorAll('.lock-padding');
var popup = document.querySelector('.popup');
// const addBtn = document.querySelectorAll('.picture_add');
var addBtn = document.querySelector('.picture__add');
var modalSelectBoard = document.querySelector('.photo-board');
var closeModalSelectBoard = document.querySelector('.close');
var complainModal = document.querySelector('.complains');
var closeComplainModal = document.querySelector('.complain__close');
var pictureMenu = document.createElement('div');
pictureMenu.classList.add('picture__menu');
var pictureAdd = document.createElement('button');
...
var pictureComplain = document.createElement('button');
...
pictureAdd.addEventListener('click', function (e) {
  modalSelectBoard.style.opacity = '1';
  modalSelectBoard.style.visibility = 'visible';
});
closeModalSelectBoard.addEventListener('click', function (e) {
...
pictureComplain.addEventListener('click', function (e) {
  complainModal.style.opacity = '1';
  complainModal.style.visibility = 'visible';
});
closeComplainModal.addEventListener('click', function (e) {
...
},{}]},{},["C:/Users/admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/modal-windows.js"], null)
//# sourceMappingURL=/modal-windows.f30fdd69.js.map